...
useRoute is used to find the closest match in the component or if its nested in another route.

2. How would you explain form validation to someone who has never programmed before?
Form validation is code that checks to see if the the text you put in the text field is valid or sufficient enough.

3. In 1-2 sentences, define end to end testing.
end to end testing acts as a user to make sure everything works correctly and smoothly
